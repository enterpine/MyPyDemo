def getTargetList():
    ...
    baseList = [
        ...
        #需要模拟浏览器
        ["政府官网", "唐山市教育考试院", "教育要闻", "http://jiaoyuju.tangshan.gov.cn/tswenguangxin/shijiaoyuju1jyyw/","/html/body/div[2]/div[2]/div[3]/div[2]/ul/li/a","/html/body/div[2]/div[2]/div[1]/div/div[2]/div[1]/span[1]","utf-8"],
